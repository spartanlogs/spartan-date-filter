...
func init() {
	filters.Register("date", newDateFilter)
}
...
func newDateFilter(options utils.InterfaceMap) (filters.Filter, error) {
...
func (f *DateFilter) Filter(batch []*event.Event, matchedFunc filters.MatchFunc) []*event.Event {
